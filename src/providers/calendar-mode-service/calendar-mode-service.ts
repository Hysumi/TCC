...
export class CalendarModeService {
  ...
  selectWeek() {
    ...
    this.selectedWeek = this.changeSelectedWeek(this.selectedDay.getDate() - 14,
    ...
    this.selectedWeek = this.changeSelectedWeek(this.selectedDay.getDate() + 7,
                                                this.selectedDay.getDay(),
                                                this.selectedDay.getMonth());
    var _week3 = _.cloneDeep(this.selectedWeek);
    
    this.selectedWeek = this.changeSelectedWeek(this.selectedDay.getDate() + 14,
                                                this.selectedDay.getDay(),
                                                this.selectedDay.getMonth());
    var _week4 = _.cloneDeep(this.selectedWeek);

    this.weekVector = [_week0, _week1, _week2, _week3, _week4];
  ...
  weekPlus() {
    this.selectedWeek = this.changeSelectedWeek(this.weekVector[4][this.selectedDay.getDay()].Day + 14,
                                                                  this.selectedDay.getDay(),
                                                                  this.weekVector[4][this.selectedDay.getDay()].Month);
    var _week4 = _.cloneDeep(this.selectedWeek);
    ApplicationRef.apply(this.weekVector);     
  }

  weekMinus() {
    this.selectedWeek = this.changeSelectedWeek(this.selectedWeek[this.selectedDay.getDay()].Day - 7,
      this.selectedDay.getDay(),
      this.selectedWeek[this.selectedDay.getDay()].Month);
    ApplicationRef.apply(this.selectedWeek);
  }
